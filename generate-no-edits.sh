...
## This script is for testing purposes, it does not do any editing.
## it just takes all the .svg files in /src/ directory
## converts them to .png files, and then passes those
## .png files to xcursorgen
